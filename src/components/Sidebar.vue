        ...
        >
          <template #reference>
            <el-menu-item class="account">
              <el-avatar :size="50">
                <img src="../assets/default-avatar.jpg" height="1900" width="1900"/></el-avatar>
          ...
          <template #default>
            ...
            >
              <div class="user-details">
                <el-avatar :size="50" style="margin-bottom: 8px">
                  <img src="../assets/default-avatar.jpg" height="1900" width="1900"/></el-avatar>
